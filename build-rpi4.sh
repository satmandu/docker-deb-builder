...
#     bindeb-pkg"'
    ...
    [[ $LOCALVERSION ]] && [[ $BUILDNATIVE ]] && \
    debcmd='nproc | xargs -I % /arm64_chroot/bin/bash-static -c "make -j% CCPREFIX=aarch64-linux-gnu- ARCH=arm64 CROSS_COMPILE=aarch64-linux-gnu- LOCALVERSION=${LOCALVERSION} O=$workdir/kernel-build/ bindeb-pkg"' 
